...
export default function SetupProfile({ session }) {
  ...
  return (
    <div style={s.page}>
      <div style={s.top} className="fadeUp">
        <div style={s.logo}>splitr</div>
        <p style={s.sub}>set up your profile</p>
      </div>
      <form onSubmit={handleSubmit} style={{ ...glass, padding:'24px' }} className="fadeUp">
        <div style={s.group}>
        ...
        <div style={s.group}>
          ...
          <p style={s.hint}>needed for one-tap UPI payments</p>
        </div>
...
const s = {
  page:{ minHeight:'100dvh', background:C.bg, display:'flex', flexDirection:'column', justifyContent:'center', padding:'40px 24px', position:'relative', zIndex:1 },
  top:{ marginBottom:'36px' },
  logo:{ fontSize:'36px', fontWeight:'800', color:C.teal, letterSpacing:'-1.5px', marginBottom:'6px', textShadow:'0 0 30px #00D4AA44' },
  ...
  input:{ width:'100%', padding:'14px 16px', fontSize:'16px', background:'rgba(255,255,255,0.05)', backdropFilter:'blur(10px)', color:C.white, border:'1.5px solid rgba(255,255,255,0.1)', borderRadius:'12px', outline:'none' },
